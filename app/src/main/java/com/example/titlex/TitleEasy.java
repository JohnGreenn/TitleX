 ...
 * author：Christiano
 * gitee:
 * time：2021/05/26 14:26
 */
public class TitleEasy extends RelativeLayout {
    ...
    public TitleEasy(Context context) {
        super(context);
        initView(context);
    }

    public TitleEasy(Context context,AttributeSet attrs) {
        super(context,attrs);
        initTypedArray(context, attrs);
        initView(context);
    }

    public TitleEasy(Context context,AttributeSet attrs,int defStyleAttr) {
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.TitleEasy);
        mColor = mTypedArray.getColor(R.styleable.TitleEasy_title_bg, 0);
        mTextColor = mTypedArray.getColor(R.styleable.TitleEasy_title_text_color, Color.WHITE);
        titlename = mTypedArray.getString(R.styleable.TitleEasy_title_text);
        //获取资源后要及时回收
        mTypedArray.recycle();
    }
